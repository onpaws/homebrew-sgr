# This is a WIP.
# Goal is to meet requirements @ https://docs.brew.sh/Acceptable-Formulae

# If you want to hack on this on your machine, first ensure Homebrew is installed
# Then run:
# brew create --python https://github.com/splitgraph/sgr/archive/refs/tags/v0.3.10.tar.gz
# which will create a stub formula in the right place for dev.
# Then paste this file over the stub (brew create should open the stub in your editor).

# To attempt installing the formula, try:
# brew install --verbose --debug --build-from-source sgr

# TODO: once this formula is working, rename class Splitgraph to Sgr AND filename splitgraph -> sgr
class Splitgraph < Formula
  ...
  url "https://github.com/onpaws/sgr/archive/refs/tags/v0.3.10.tar.gz"
  ...
  test do
    ...
    # software. Run the test with `brew test sgr`. Options passed
